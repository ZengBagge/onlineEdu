...
function update(id){
  $("#addTopic_iframe").attr("src","topicCheckBox!update?checkBoxTopicId="+id);
}
</script>
  </head>
  ...
  <body>
      ...
      <s:iterator value="pageBean.list" var="u">
          <tr>
            ...
            <s:iterator value="#u.answers" var="a">
            <td><s:property  value="#a.body" /></td>
            </s:iterator>
            <td style="text-align:center;">
               <s:property  value="#u.checkAnswerTrue" />
           </td>
...
　　　    <li ><a href="topicCheckBox!getCheckList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页<span aria-hidden="true">&rarr;</span></a></li>
      </s:if>
      <s:elseif test="%{pageBean.currentPage < pageBean.totalPage}">
    <li ><a href="topicCheckBox!getCheckList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage-1}"/>"><span aria-hidden="true">&larr;</span>上一页</a></li>
    <li ><a href="topicCheckBox!getCheckList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页<span aria-hidden="true">&rarr;</span></a></li>
       </s:elseif>
       　<s:else>
　　　　    <li ><a href="topicCheckBox!getCheckList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage-1}"/>"><span aria-hidden="true">&larr;</span>上一页</a></li>
