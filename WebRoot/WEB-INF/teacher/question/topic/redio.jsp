...
function del(id,dom){
if(confirm("确定要删除么？")){
 addTopicRedio.del(id,function(result){
   if(result){
...
function update(id){
  $("#addTopic_iframe").attr("src","topicRedio!update?redioTopicId="+id);
}
</script>
      ...
      <s:iterator value="pageBean.list" var="u">
          <tr>
           <td style="text-align:center;"> <s:property  value="#u.topic.tid" /></td>
            ...
            <td><s:property  value="#u.answerA" /></td>
            <td><s:property  value="#u.answerB" /></td>
            <td><s:property  value="#u.answerC" /></td>
            <td><s:property  value="#u.answerD" /></td>
            <td><s:property  value="#u.answerE" /></td>
            <td style="text-align:center;">
            <s:if test="#u.answer==1">A</s:if>
            <s:elseif test="#u.answer==2">B</s:elseif>
             <s:elseif test="#u.answer==3">C</s:elseif>
              <s:elseif test="#u.answer==4">D</s:elseif>
              <s:elseif test="#u.answer==5">E</s:elseif>
           </td>
...
　　　    <li ><a href="topicRedio!getRedioList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页<span aria-hidden="true">&rarr;</span></a></li>
      </s:if>
      <s:elseif test="%{pageBean.currentPage < pageBean.totalPage}">
    <li ><a href="topicRedio!getRedioList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage-1}"/>"><span aria-hidden="true">&larr;</span>上一页</a></li>
    <li ><a href="topicRedio!getRedioList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页<span aria-hidden="true">&rarr;</span></a></li>
       </s:elseif>
       　<s:else>
　　　　    <li ><a href="topicRedio!getRedioList?courseId=<s:property value="%{courseId}"/>&page=<s:property value="%{pageBean.currentPage-1}"/>"><span aria-hidden="true">&larr;</span>上一页</a></li>
