   ...
   <script src="<%=basePath%>inc/js/bootstrap.min.js"></script>
    ...
    <script>
      function discuzCourse(id){
           window.location.href="course!courseInfo?courseId="+id; 
      }
    </script>
  </head>
       ...
       <div class="course_group">
            <div class="course_self">
               ...
               <s:action name="course!getCourse" namespace="/" var="course"  ></s:action>
                 ...
                 <div class="bookname"  onclick="discuzCourse(<s:property  value="#u.id" />)"><h4 title="查看课程信息"><s:property  value="#u.titleString" /></h4></div>
                 <div class="personalgroup-setting" title="课程设置" data-title="<s:property  value="#u.titleString" />" data-toggle="modal" data-target="#course_info" data-id="<s:property  value="#u.id" />"><i class="icon icon-w icon-xsz icon-cog-fat"></i></div>
                 </li>
                 </s:iterator>
                 <li class="tbc" data-url="course!addCourse" title="添加课程" data-toggle="modal" data-target="#course_info" ></li>
               </ul>
            </div>
       </div>
       <!-- 课程信息框 -->
...
<script type="text/javascript">
		...
		$(".course_self ul li .personalgroup-setting").each(function(){
			$(this).click(function(){
				$("#course_iframe").attr("src","course!infoSet?courseId="+$(this).attr("data-id"));
