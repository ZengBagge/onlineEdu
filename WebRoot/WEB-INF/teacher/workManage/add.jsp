 ...
 <script> 
        ...
        $(function(){
           ...
           $("#courseTest").on("change",function(){
               if($(this).val() !="")
                addWorkTopic.getWorkTopic($(this).val(),function(result){
                   if(result != null)
                     {
           ...
           <div class="course_main">
               <form action="course!addForm" method="post" class=" form-horizontal">
                    <div class="form-group">
                            ...
                            <div class="col-sm-8">
                           <input type="text" class="form-control" id="workName" placeholder="任务名称" check-type="required" required-message="请填写任务名称" value="<s:property  value="work.titleString" />"/>
                            <s:if test="work != null">
                            <input type="hidden" value="<s:property  value="work.id" />" id ="work_id"/>
                            </s:if>
                            </div>
                    </div>
                     <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <span class="addicon">
                              <i class="icon icon-b icon-add-circle" title="选取专业" data-toggle="modal" data-target="#workMajor"></i>
                              </span>
                              
                              <s:if test="work != null">
                              <ul class="after_add" id="after_add">
                                <s:iterator value="work.classes" var="w">
                      ...
                      <div class="form-group">
                           ...
                           <select class="form-control" id="courseTest"  >      
                            <s:action name="course!getCourse" namespace="/" var="course"  ></s:action>
                             <option value="<s:property  value="work.course.id" />"><s:property  value="work.course.titleString" /></option>
                      ...
                      <div class="form-group">
                           ...
                           <select class="form-control" id="workTopic"  >      
                             <option value="<s:property  value="work.workTopic.id" />"><s:property  value="work.workTopic.titleString" /></option>
                           </select>
                            </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                 <div class="input-append date form_datetime" id="startTime">
							    <input size="16" type="text" readonly class="form-control"  id="firstDate" placeholder="点击选择" check-type="required" required-message="请选择开始时间" value="<s:date name="work.startDate" format="yyyy-MM-dd hh:mm" />"> 
                       ...
                       <div class="form-group">
                            <label for="courseName" class="col-sm-2 control-label">结束时间</label>
                            <div class="col-sm-8">
                                 <div class="input-append date form_datetime"  id="endTime">
							    <input size="16" type="text"  readonly class="form-control"  id="lastDate" placeholder="点击选择" check-type="required" required-message="请选择结束时间" value="<s:date name="work.endDate" format="yyyy-MM-dd hh:mm" />"> 
							    <span class="add-on"><i class="icon-th"></i></span>
						        </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <textarea id="workIntroduce" name="workIntroduce" class="form-control" placeholder="对本次任务进行简单说明" ><s:property  value="work.description" /></textarea>
                            </div>
                    </div >
                    <div class="form-group">
			 ...
			 $(function(){
			   ...
			   $("#course_btn").on('click',function(event){
			    ...
			    {  
			          ...
			          addWork.addForm(workName,workMajor,courseId,beginTime,endTime,workTopic,workIntroduce,function(result){
                         if(result){
			 ...
			 $(function(){
			   ...
			   $("#course_btn_update").on('click',function(event){
			    ...
			    {  
                      ...
                      var id=$("#work_id").val();
			          addWork.setForm(id,workName,workMajor,courseId,beginTime,endTime,workTopic,workIntroduce,function(result){
                         if(result){
