  ...
  <script SRC="dwr/engine.js"></script>
   ...
   <script SRC="dwr/interface/addWorkTopic.js"></script>
    <script>
     function del(id){
      if(confirm("确定你要删除它么？")){
        addWorkTopic.del(id,function(result){
         if(result){
           $("#workTopic"+id).remove();
         }else{
  ...
  <body class="menu_body">
       <div class="course_group">
            <div class="course_self">
               ...
               <ul>
                            <s:action name="workTopic!getWorkTopic" namespace="/" var="w"  ></s:action>
                             <s:iterator value="#w.workTopicList" var="u">
                 <li title="<s:property  value="#u.titleString" />" class="personal-group" id="workTopic<s:property  value="#u.id" />">
