...
<html>
  <head>
   ...
   function del(id,dom){
           if(confirm("确定你要删除它么？")){
          addExam.del(id,function(result){
             if(result){
  ...
  <body class="menu_body">
       <div class="course_group" id="groupIndex">
            <div class="course_self kb">
               ...
               <ul>
                            <s:action name="examManage!getExamingManage" namespace="/" var="w"  ></s:action>
                             <s:iterator value="#w.examingManageList" var="u">
                 ...
                 <li class="tbc" data-url="examManage!addExam" title="添加任务" data-toggle="modal" data-target="#work_info" ></li>
               </ul>
            </div>
            ...
            <div class="course_self kb">
               ...
               <div class="hr">
                  <i class="icon icon-b icon-angle-double-up"></i>
                       ...
                       <s:action name="examManage!getExamedManage" namespace="/" var="w"  ></s:action>
                 <div class="table-work">    
                   <table class="table table-bordered">
					        <thead>
					          <tr>
					            <th width="40%">考试任务名称</th>
					            <th width="17%">开始时间</th>
					            <th width="17%">结束时间</th>
					             <th width="10%">考试时长</th>
					            <th width="9%">完成情况</th>
                            ...
                            <tbody>
                                 <s:iterator value="#w.examedManageList" var="u">
                                    <tr>
                                       ...
                                       <td><s:date name="#u.endDate" format="yyyy-MM-dd hh:mm" /></td>
                                         <td><s:property  value="#u.examTimes" />分钟</td>
                                       <td><s:property  value="#u.wan" />/<s:property  value="#u.zong" /></td>
                                       <td>
                                        <a href="javascript:void(0)" onclick="del(<s:property  value="#u.id" />,this)">删除</a>
                                       </td>
                                 </s:iterator>
                            </tbody>
                      </table>   
...
<script type="text/javascript">
		...
		$(".course_self ul li .personalgroup-setting").each(function(){
			$(this).click(function(){
				$("#course_iframe").attr("src","examManage!setInfo?examId="+$(this).attr("data-id"));
