        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <!-- start logo -->
                    <a title="<s:property value="#session.user.tname" />的博客" href="blog!index" class="branding"><img alt="<s:property value="#session.user.tname" />的博客" src="<%=basePath%>inc/image/avatar/<s:property value="#session.user.picString" />"></a>
                    <!-- end logo -->
                    <h2 class="text-center"><s:property value="#session.user.tname" /></h2>
                </div>
            </div>
        </div>
    </header>
...
<nav role="navigation" class="pagination">
    ...
    <s:elseif test="pageBean.currentPage==1">
    <span class="page-number">第 <s:property value="pageBean.currentPage"/> 页 ⁄ 共<s:property value="pageBean.totalPage"/> 页</span>
     ...
     <a href="blog!index?page=<s:property value="page+1"/>" class="older-posts" title="下一页"><i class="fa fa-chevron-right fa-1x"></i></a>
                ...
                <div class="widget">
                	...
                	<div class="content download">
                		<a class="btn btn-default btn-block" href="blog!add">点击发布</a>
                	</div>
                </div>
                <!-- start tag cloud widget -->
                <div class="widget">
