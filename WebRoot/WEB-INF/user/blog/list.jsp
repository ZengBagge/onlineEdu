        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <!-- start logo -->
                    <a title="<s:property value="userCommon.tname" />的博客" href="blog!index" class="branding"><img alt="<s:property value="userCommon.tname" />的博客" src="<%=basePath%>inc/image/avatar/<s:property value="userCommon.picString" />"></a>
                    <!-- end logo -->
                    <h2 class="text-center"><s:property value="userCommon.tname" /></h2>
                </div>
            </div>
        </div>
    </header>
     ...
     <a href="blog!index?page=<s:property value="page+1"/>" class="older-posts" title="下一页"><i class="fa fa-chevron-right fa-1x"></i></a>
                ...
                <div class="widget">
                	...
                	<div class="content community blogTyleList">
                		...
                		<ul>
                		 <s:iterator value="nextBlogTypes" var="bt">
                ...
                <div class="widget">
                	...
                	<div class="content download">
                		<a class="btn btn-default btn-block" href="blog!add?typeId=<s:property value="typeId"/>">点击发布</a>
                	</div>
                </div>
                <!-- start tag cloud widget -->
                </s:if>
