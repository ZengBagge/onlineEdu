...
<html>
  ...
  <body>
     <div class="container-full">
      <h2 style="text-align:center;">选择课程（自主练习）</h2>
      <div class="my_course_box midle_bg row">
      <s:iterator value="courses" var="c">
         <div class="inline_two mb30 col-sm-4">
				<a  href="work!selfCollectTopic?courseId=<s:property  value="#c.id" />"><img width="230" height="150" src="<%=basePath%>inc/image/eg_1.png" class="mr10 bd3cc l"></a>
                <div class="cell g9">
                    <div class=" g5 f16"><a  href="work!selfCollectTopic?courseId=<s:property  value="#c.id" />" target="_blank"><s:property  value="#c.titleString" /></a></div>
