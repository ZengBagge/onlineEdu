  ...
  <head>
   ...
   <script src="<%=basePath%>inc/js/bootstrap.min.js"></script>
       <script SRC="dwr/engine.js"></script>
	    ...
	    <script SRC="dwr/interface/work.js"></script>
...
$(function(){
    ...
    var jq= $(".topic_show.active .active");
       if(jq.prev().prev().length>0)
    {
    jq.removeClass("active");
    jq.prev().addClass("active");
    ...
    $(".topic_show.active .next").show();
       ...
       jq.removeClass("active");
       jq.prev().addClass("active");
       $(".topic_show.active .prev").hide();
       $(".topic_show.active .next").show();
    }
  });
});
var result = new Array();
var re = <s:property value="workTopicSize"/>;
$(function(){
		for(var i=0;i<re;i++){
			result.push(0);
		}
 ...
 <script src="<%=basePath%>inc/js/check.js"></script>
  </head>
  ...
  <body class="conduct"  >
     <header class="container-full">
             <div class="container">
                   ...
                   <h1 class="her_ans_tip">练习计时&nbsp;:&nbsp;
                         <span class="yel1 fa f20">
                             <span class="tim"></span>
                             <span style="display: none" id="datetimeNow">2015-03-14 15:05:28 </span>
                       </span>
                </h1>
        </div>
    </header>
    ...
    <ul class="list-group type_list">
       <s:iterator value="workTopic.questionTypes" var="wq">
        <li data-id="<s:property value="#wq.id"/>"> <span>  <s:property value="#wq.titleString"/></span></li>
        
      </s:iterator>   
     </ul>                                
       <span class="handPaper" data-id="<s:property value="workId"/> ">交卷</span>                           
     </div>
     <div class="topic_box">
            <s:iterator value="workTopic.questionTypes" var="wq2">
	          <div class="topic_show" data-id="<s:property value="#wq2.id"/>" id="show<s:property value="#wq2.id"/>">

	          <s:iterator value="workTopic.topicList" var="wt">
	            ...
	            <div class="topicType">
	            <span><s:property value="#wt.topicType.name"/></span>
	            </div>  
	            <div class="source">
	              <span>题目来源：<s:property value="#wt.sourceString"/></span>
	            </div>          
	            <div class="key">
	               <span>
	           ...
	           <div class="message">
	             ...
	             <h2 class="vary" >
	               <span class="prev" style="display:none;">上一题</span>
