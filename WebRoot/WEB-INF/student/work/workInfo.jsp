  ...
  <body>
	...
	<div class="row">
		<div class="col-lg-8 col-lg-push-2">
		    <h1 class="blog-title">
		    	<a ><s:property  value="work.titleString" /></a>
		    </h1>
		    <h2 class="blog-desc">
		    	 <p>任务起止时间：<s:date name="work.startDate" format="yyyy-MM-dd HH:mm:ss" />—<s:date name="work.endDate" format="yyyy-MM-dd HH:mm:ss" /></p>
		    	 <p>任务所属班级：<s:iterator value="work.classes" var="c2"><s:property  value="#c2.name" />|</s:iterator></p>
		    	 <p>任务发布教师：<s:property  value="work.teacherUser.userCommon.tname" /></p>
		    </h2>
		    <div class="social mt30">
			    <a  target="_blank" title="异形网络教育|开始任务" class="btn btn-outline btn-lg" href="work!conduct?workId=<s:property  value="work.id" />&token=<s:property  value="token" />">开始任务</a>
