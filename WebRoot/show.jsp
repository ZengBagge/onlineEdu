     ...
     <a href="blog!index?page=<s:property value="page+1"/>" class="older-posts" title="下一页"><i class="fa fa-chevron-right fa-1x"></i></a>
                ...
                <div class="widget">
                	...
                	<div class="content community">
                		<p>QQ：576501057</p>
                		<p><a onclick="_hmt.push(['_trackEvent', 'big-button', 'click', '问答社区'])" target="_blank" title="" href=""><i class="fa fa-comments"></i> 问答社区</a></p>
                		<p><a onclick="_hmt.push(['_trackEvent', 'big-button', 'click', '官方微博'])" target="_blank" title="" href=""><i class="fa fa-weibo"></i> 官方微博</a></p>
                	</div>
                </div>
